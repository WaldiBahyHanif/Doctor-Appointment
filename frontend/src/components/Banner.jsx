    ...
    <div className="flex px-6 my-20 rounded-lg bg-primary sm:px-10 md:px-14 lg:px-12 md:mx-10">
      ...
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        <div className="text-xl font-semibold text-white sm:text-2xl md:text-3xl lg:text-5xl">
          ...
          <p className="mt-4">Dengan 100+ Dokter Berpengalaman</p>
        </div>
        <button
          onClick={() => {
            navigate("/login");
          ...
          className="px-8 py-3 mt-6 text-sm text-gray-700 transition-all bg-white rounded-full shadow-md sm:text-base hover:scale-105"
        >
          Buat Akun Sekarang
        </button>
      </div>
